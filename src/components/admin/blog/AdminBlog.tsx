...
import { Loader2, Plus, Edit, Trash2, ExternalLink, Search, FileText } from 'lucide-react';
  ...
  return (
    <div className="space-y-4">
                  ...
                  <TableRow key={post.id}>
                    ...
                    <TableCell className="text-right">
                      <div className="flex justify-end gap-1">
                        ...
                        <Button variant="ghost" size="icon" onClick={() => setDeletingPost(post)} title="Delete">
      ...
      <AlertDialog open={!!deletingPost} onOpenChange={open => { if (!open) setDeletingPost(null); }}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete "{deletingPost?.title}"?</AlertDialogTitle>
            <AlertDialogDescription>
